...
kable(nd, caption = "Model results show that ultra-rare disease and high budget organizations are more likely to prioritize research, while rare disease organizations are more likely to prioritize family education.", align = "c")
```

### Research Internal vs. External

The second model we ran was using Research as the response variable, and Frequency and Budget as predictors. The model output and residual plots are shown in Figure __. All of the predictors are non-significant at the 0.05 alpha level, suggesting that there is no relationship between Frequency and Budget and the whether the organizations' research is conducted internally, externally, or both. 
